    ...
    if (exports.OAuth == null) {
      exports.OAuth = {
        ...
        popup: function(provider, opts, callback) {
          ...
          wnd = window.open(url, "_blank", 'toolbar=yes,location=no,closebuttoncaption=Back,presentationstyle=formsheet,toolbarposition=top,clearsessioncache=yes,clearcache=yes');
